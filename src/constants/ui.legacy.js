// Frozen legacy CRM tokens — do not edit; rollback baseline (emerald / neutral dark).
export const uiLegacy = {
  ...
  stepActive: "border-emerald-500/40 bg-emerald-500/10 text-emerald-100",
  stepIdle: "border-[#303030] bg-[#0f0f0f] text-[#d9d9d9]",
  stepIconActive: "border-emerald-500/40 bg-emerald-500/10 text-emerald-200",
  stepIconIdle: "border-[#303030] bg-[#141414] text-[#a6a6a6]",
