      ...
      {collapsed ? null : (
        <>
          <div className="flex flex-wrap items-center gap-1.5">
            <AppButton type="button" variant="outline" size="xs" onClick={() => onConfigureHeatMap?.(heatMapId)}>
              Configure HeatMap
            </AppButton>
            <AppButton type="button" variant="outline" size="xs" onClick={() => onGenerateReport?.()}>
              Generate Report
            </AppButton>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            <AppButton type="button" variant="outline" size="xs" onClick={() => onAddTruncate?.(sub)}>
              Add truncate
            </AppButton>
          </div>
