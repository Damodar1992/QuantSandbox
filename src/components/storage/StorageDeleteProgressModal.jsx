...
export function StorageDeleteProgressModal({ deleteOp, onDismiss }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60">
      <div className="rounded-lg bg-[#141414] border border-[#303030] max-w-[480px] w-full overflow-hidden flex flex-col shadow-xl">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#303030]">
          <span className="text-[13px] font-semibold text-foreground">
            {inProgress ? "Deleting RAW Data" : "Deletion Result"}
          </span>
          {isDone && (
